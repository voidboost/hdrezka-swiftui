<h1>🎬 HDrezka для macOS (неофіційний клієнт)</h1>
<p>Неофіційний клієнт HDrezka для macOS. <br>Потрібна <b>macOS 15 Sequoia</b> або новіша.</p>
...
<ul>
   ...
   <li>Також рекомендується ознайомитися з <a href="https://rezka.ag/rules/"><b>правилами сайту</b></a>.</li>
</ul>
<h2>✨ Можливості</h2>
<ul>
...
<h2>📦 Встановлення за допомогою <a href="https://brew.sh/uk/">Homebrew</a></h2>
...
<h3 id="installation-troubleshooting">Помилка під час встановлення або запуску на macOS</h3>
