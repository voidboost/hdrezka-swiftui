...
struct RenameBookmarkSheetView: View {
    ...
    var body: some View {
                    ...
                    VStack(alignment: .center, spacing: 10) {
                        Button {
                            ...
                            Text("key.rename")
                                ...
                                .background(!name.trim().isEmpty && name.trim() != bookmark.name ? Color.accentColor : Color.secondary, in: .rect(cornerRadius: 6))
                        }
                        .buttonStyle(.plain)
        ...
        .frame(width: 520)
        .analyticsScreen(name: "rename_bookmark_sheet", class: "RenameBookmarkSheetView")
    }
