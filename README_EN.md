<h1>🎬 HDrezka for macOS (Unofficial Client)</h1>
<p>Unofficial HDrezka client for macOS. <br>Requires <b>macOS 15 Sequoia</b> or newer.</p>
<h2>⚠️ Disclaimer</h2>
<ul>
...
<ul>
    <li>
        <span>💻</span>
        <a href="https://github.com/voidboost/hdrezka-swiftui/releases/latest" target="_blank">Download latest version (macOS 15 Sequoia or newer)</a>
    </li>
</ul>
...
<h3 id="installation-troubleshooting">Error during installation or launch on macOS</h3>
